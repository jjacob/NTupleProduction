...
bool TopPairElectronPlusJetsSelectionFilter::filter(edm::Event& iEvent, const edm::EventSetup& iSetup, std::string MCSampleTag) {
...
void TopPairElectronPlusJetsSelectionFilter::setupEventContent(edm::Event& iEvent, std::string MCSampleTag) {
	if (debug_)
...
void TopPairElectronPlusJetsSelectionFilter::cleanedJets(std::string MCSampleTag) {
	cleanedJets_.clear();
...
bool TopPairElectronPlusJetsSelectionFilter::isGoodJet(const pat::Jet& jet, std::string MCSampleTag) const {
...
bool TopPairElectronPlusJetsSelectionFilter::passesSelectionStep(edm::Event& iEvent,
		unsigned int selectionStep, std::string MCSampleTag) const {
...
bool TopPairElectronPlusJetsSelectionFilter::hasAtLeastOneGoodJet(std::string MCSampleTag) const {
...
bool TopPairElectronPlusJetsSelectionFilter::hasAtLeastTwoGoodJets(std::string MCSampleTag) const {
...
bool TopPairElectronPlusJetsSelectionFilter::hasAtLeastThreeGoodJets(std::string MCSampleTag) const {
...
bool TopPairElectronPlusJetsSelectionFilter::hasAtLeastFourGoodJets(std::string MCSampleTag) const {
