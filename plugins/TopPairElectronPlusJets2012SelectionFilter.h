...
private:
	...
	edm::InputTag hcalLaserFilterInput_, ecalDeadCellFilterInput_, manystripclus53X_, toomanystripclus53X_, logErrorTooManyClusters_, trackingFailureFilter_, eeBadScFilter_;
